...
Pressing Tilt 1 and Tilt 2 simultaneously with directional buttons will make them function according to `Tilt 1 then 2 Mode` and `Tilt 2 then 1 Mode`.
...
Pressing Rotate 1 and Rotate 2 simultaneously with directional buttons will make them function according to `Rotate 1 then 2 Mode` and `Rotate 2 then 1 Mode`.
...
- `Tilt 1 then 2 Mode` - How the direction keys will function when pressing both Tilt 1&2, but first 1 then 2.
- `Tilt 2 then 1 Mode` - How the direction keys will function when pressing both Tilt 1&2, but first 2 then 1.
- `Rotate 1 then 2 Mode` - How the direction keys will function when pressing both Rotate 1&2, but first 1 then 2.
- `Rotate 2 then 1 Mode` - How the direction keys will function when pressing both Rotate 1&2, but first 2 then 1.
...
|   -   |   -   |    X    |    -    | ⇨ |    Rotate1    |    Rotate1    |
|   -   |   -   |    -    |    X    | ⇨ |    Rotate2    |    Rotate2    |
|   X   |   X   |    -    |    -    | ⇨ | Selected Mode | Selected Mode |
|   -   |   -   |    X    |    X    | ⇨ | Selected Mode | Selected Mode |
|   X   |   -   |    X    |    -    | ⇨ |    Rotate3    |    Rotate3    |
|   -   |   X   |    X    |    -    | ⇨ |    Rotate4    |    Rotate4    |
|   X   |   -   |    -    |    X    | ⇨ |    Rotate5    |    Rotate5    |
