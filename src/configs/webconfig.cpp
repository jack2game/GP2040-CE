...
std::string setAddonOptions()
{
    ...
    docToValue(tiltOptions.factorTilt3LeftX, doc, "factorTilt3LeftX");
    docToValue(tiltOptions.factorTilt3LeftY, doc, "factorTilt3LeftY");
    docToValue(tiltOptions.factorTilt3RightX, doc, "factorTilt3RightX");
    docToValue(tiltOptions.factorTilt3RightY, doc, "factorTilt3RightY");
    docToValue(tiltOptions.factorTilt4LeftX, doc, "factorTilt4LeftX");
    docToValue(tiltOptions.factorTilt4LeftY, doc, "factorTilt4LeftY");
    docToValue(tiltOptions.factorTilt4RightX, doc, "factorTilt4RightX");
    docToValue(tiltOptions.factorTilt4RightY, doc, "factorTilt4RightY");
...
std::string getAddonOptions()
{
    ...
    writeDoc(doc, "factorTilt3LeftX", tiltOptions.factorTilt3LeftX);
    writeDoc(doc, "factorTilt3LeftY", tiltOptions.factorTilt3LeftY);
    writeDoc(doc, "factorTilt3RightX", tiltOptions.factorTilt3RightX);
    writeDoc(doc, "factorTilt3RightY", tiltOptions.factorTilt3RightY);
    writeDoc(doc, "factorTilt4LeftX", tiltOptions.factorTilt4LeftX);
    writeDoc(doc, "factorTilt4LeftY", tiltOptions.factorTilt4LeftY);
    writeDoc(doc, "factorTilt4RightX", tiltOptions.factorTilt4RightX);
    writeDoc(doc, "factorTilt4RightY", tiltOptions.factorTilt4RightY);
