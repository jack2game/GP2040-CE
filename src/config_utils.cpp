...
void ConfigUtils::initUnsetPropertiesWithDefaults(Config& config)
{
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt3LeftX, TILT3_FACTOR_LEFT_X);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt3LeftY, TILT3_FACTOR_LEFT_Y);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt3RightX, TILT3_FACTOR_RIGHT_X);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt3RightY, TILT3_FACTOR_RIGHT_Y);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt4LeftX, TILT4_FACTOR_LEFT_X);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt4LeftY, TILT4_FACTOR_LEFT_Y);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt4RightX, TILT4_FACTOR_RIGHT_X);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, factorTilt4RightY, TILT4_FACTOR_RIGHT_Y);
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, rotate1Pin, (Pin_t)-1);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, rotate2Pin, (Pin_t)-1);
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, tilt1Then2Mode, TILT_1_THEN_2_MODE);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, tilt2Then1Mode, TILT_2_THEN_1_MODE);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, rotate1Then2Mode, ROTATE_1_THEN_2_MODE);
    INIT_UNSET_PROPERTY(config.addonOptions.tiltOptions, rotate2Then1Mode, ROTATE_2_THEN_1_MODE);
...
void gpioMappingsMigrationCore(Config& config)
{
    ...
    if (tiltOptions.enabled) {
        ...
        if (tiltOptions.factorTilt3LeftX == -1) tiltOptions.factorTilt3LeftX = TILT3_FACTOR_LEFT_X;
        if (tiltOptions.factorTilt3LeftY == -1) tiltOptions.factorTilt3LeftY = TILT3_FACTOR_LEFT_Y;
        if (tiltOptions.factorTilt3RightX == -1) tiltOptions.factorTilt3RightX = TILT3_FACTOR_RIGHT_X;
        if (tiltOptions.factorTilt3RightY == -1) tiltOptions.factorTilt3RightY = TILT3_FACTOR_RIGHT_Y;
        if (tiltOptions.factorTilt4LeftX == -1) tiltOptions.factorTilt4LeftX = TILT4_FACTOR_LEFT_X;
        if (tiltOptions.factorTilt4LeftY == -1) tiltOptions.factorTilt4LeftY = TILT4_FACTOR_LEFT_Y;
        if (tiltOptions.factorTilt4RightX == -1) tiltOptions.factorTilt4RightX = TILT4_FACTOR_RIGHT_X;
        if (tiltOptions.factorTilt4RightY == -1) tiltOptions.factorTilt4RightY = TILT4_FACTOR_RIGHT_Y;
        if (tiltOptions.factorRotate1Left == -1) tiltOptions.factorRotate1Left = ROTATE1_FACTOR_LEFT;
        if (tiltOptions.factorRotate2Left == -1) tiltOptions.factorRotate2Left = ROTATE2_FACTOR_LEFT;
        if (tiltOptions.factorRotate3Left == -1) tiltOptions.factorRotate3Left = ROTATE3_FACTOR_LEFT;
        if (tiltOptions.factorRotate4Left == -1) tiltOptions.factorRotate4Left = ROTATE4_FACTOR_LEFT;
        if (tiltOptions.factorRotate1Right == -1) tiltOptions.factorRotate1Right = ROTATE1_FACTOR_RIGHT;
        if (tiltOptions.factorRotate2Right == -1) tiltOptions.factorRotate2Right = ROTATE2_FACTOR_RIGHT;
        if (tiltOptions.factorRotate3Right == -1) tiltOptions.factorRotate3Right = ROTATE3_FACTOR_RIGHT;
        if (tiltOptions.factorRotate4Right == -1) tiltOptions.factorRotate4Right = ROTATE4_FACTOR_RIGHT;

        fromProtoBuf(tiltOptions.has_tilt1Pin, &tiltOptions.tilt1Pin, GpioAction::ANALOG_DIRECTION_MOD_ONE);
        fromProtoBuf(tiltOptions.has_tilt2Pin, &tiltOptions.tilt2Pin, GpioAction::ANALOG_DIRECTION_MOD_TWO);
        ...
        fromProtoBuf(tiltOptions.has_rotate1Pin, &tiltOptions.rotate1Pin, GpioAction::ANALOG_DIRECTION_ROTATE_ONE);
        fromProtoBuf(tiltOptions.has_rotate2Pin, &tiltOptions.rotate2Pin, GpioAction::ANALOG_DIRECTION_ROTATE_TWO);
    }
