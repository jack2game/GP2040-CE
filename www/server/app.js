...
app.get('/api/getButtonLayoutDefs', (req, res) => {
	return res.send({
		buttonLayout: {
			...
			BUTTON_LAYOUT_SUNGA12KEYA: 33,
			BUTTON_LAYOUT_SUNGA13KEYA: 34,
			BUTTON_LAYOUT_SUNGA14KEYLRA: 35,
			BUTTON_LAYOUT_SUNGA14KEYUDA: 36,
			BUTTON_LAYOUT_SUNGA17KEYA: 37,
			BUTTON_LAYOUT_SUNGA17KEYAALT: 38,
			BUTTON_LAYOUT_SUNGA18KEYA: 39,
			BUTTON_LAYOUT_SUNGA18KEYAALT: 40,
			BUTTON_LAYOUT_SUNGA18KEYADUALUP: 41,
		...
		buttonLayoutRight: {
			...
			BUTTON_LAYOUT_SUNGA12KEYB: 37,
			BUTTON_LAYOUT_SUNGA13KEYB: 38,
			BUTTON_LAYOUT_SUNGA14KEYLRB: 39,
			BUTTON_LAYOUT_SUNGA14KEYUDB: 40,
			BUTTON_LAYOUT_SUNGA17KEYB: 41,
			BUTTON_LAYOUT_SUNGA17KEYBPREF: 42,
			BUTTON_LAYOUT_SUNGA18KEYB: 43,
			BUTTON_LAYOUT_SUNGA18KEYBPREF: 44
		},
	});
});
